window.addEventListener("DOMContentLoaded",function() {
  ...
  dodecahedron.setAttribute("position", "0 1 -3");      // Example position
  dodecahedron.setAttribute("radius", 0.7);             // Example radius
  dodecahedron.setAttribute("color", "#F76E6C");        // Example color
